  ...
  <div class="page on" data-page="case-detail">
    ...
    <div class="a-main cs-main">
      <div class="cs-body">
        ...
        <div class="cm-cta">
          <div class="t">想在你的企业复制这个场景？<span>先做一次轻量的 AI 落地诊断，顾问 1 个工作日内联系你。</span></div>
          <a class="btn" style="background:var(--purple-hi);color:#fff;border:0" href="/contact">预约「AI 落地诊断」<span class="arr">→</span></a>
          <button class="btn" style="border-color:var(--hair);color:var(--ink)" data-evt-click="e1">问问小瑞</button>
        </div>
      </div>
      <div class="a-side">
        ...
        <div class="a-promo">
          ...
          <div class="t">预约 AI 落地诊断</div>
          <p>通过科学的诊断模型，为你精准定位 AI 转型痛点，量化投资回报。</p>
